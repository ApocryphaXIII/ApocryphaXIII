...
/obj/structure/retail/black_market
	products_list = list(
		new /datum/data/vending_product("lighter", /obj/item/lighter/greyscale, 1),
		new /datum/data/vending_product("zippo lighter", /obj/item/lighter, 40),
		new /datum/data/vending_product("Bailer", /obj/item/bailer, 5),
		...
		new /datum/data/vending_product("snub-nose revolver", /obj/item/gun/ballistic/vampire/revolver/snub, 50),
...
/obj/structure/retail/black_market/Initialize()
	. = ..()
	if(prob(25))
		product_list += new /datum/data/vending_product("silver 9mm ammo", /obj/item/ammo_box/vampire/c9mm/silver, 5000)
	if(prob(25))
		product_list += new /datum/data/vending_product("silver .45 ACP ammo", /obj/item/ammo_box/vampire/c45acp/silver, 6000)
	if(prob(25))
		product_list += new /datum/data/vending_product("silver .44 ammo", /obj/item/ammo_box/vampire/c44/silver, 7000)
	if(prob(25))
		product_list += new /datum/data/vending_product("silver 5.56 ammo", /obj/item/ammo_box/vampire/c556/silver, 8000)
	if(prob(25))
		product_list += new /datum/data/vending_product("incendiary 5.56 ammo", /obj/item/ammo_box/vampire/c556/incendiary, 9000)
