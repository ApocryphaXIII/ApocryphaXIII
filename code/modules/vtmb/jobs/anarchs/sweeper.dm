...
/datum/outfit/job/sweeper
	...
	backpack_contents = list(/obj/item/passport=1, /obj/item/cockclock=1, /obj/item/flashlight=1, /obj/item/vamp/keys/hack=1, /obj/item/creditcard=1, /obj/item/binoculars = 1)
