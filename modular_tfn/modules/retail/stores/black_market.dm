...
/obj/structure/retail/black_market/Initialize()
	. = ..()
	if(prob(25))
		products_list += new /datum/data/vending_product("silver 9mm ammo", /obj/item/ammo_box/vampire/c9mm/silver, 5000)
	if(prob(25))
	...
	if(prob(25))
		products_list += new /datum/data/vending_product("incendiary 5.56 ammo", /obj/item/ammo_box/vampire/c556/incendiary, 9000)
