...
/datum/outfit/job/archivist
	...
	backpack_contents = list(/obj/item/passport=1, /obj/item/cockclock=1, /obj/item/flashlight=1, /obj/item/arcane_tome=1, /obj/item/creditcard=1, /obj/item/melee/vampirearms/katana/kosa=1)
