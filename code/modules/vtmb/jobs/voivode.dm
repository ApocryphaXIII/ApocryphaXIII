...
/datum/outfit/job/voivode
	...
	backpack_contents = list(/obj/item/vamp/keys/tzimisce/manor=1, /obj/item/melee/vampirearms/eguitar=1, /obj/item/passport=1, /obj/item/flashlight=1, /obj/item/creditcard/elder=1)
