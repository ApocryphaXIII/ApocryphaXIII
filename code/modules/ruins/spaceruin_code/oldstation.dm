...
/obj/item/paper/fluff/ruins/oldstation/protosuit
	...
	default_raw_text = "<b>*Prototype Hardsuit*</b><br><br>The B01-RIG Hardsuit is a prototype powered exoskeleton. Based off a recovered pre-void war era united Earth government powered military \
...
/obj/item/paper/fluff/ruins/oldstation/survivor_note
	...
	default_raw_text = "You can barely make out a faded message... <br><br>I come back to the station after a simple mining mission, and nobody is here. Well, they COULD have gone to cryo... I didn't really check. Doesn't matter, I have bigger issues now. There is something out there. \
